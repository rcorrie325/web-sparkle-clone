              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-2 text-sm">
                    ...
                    <a href="https://myemail.constantcontact.com/Fed-Data-Prospector.html?soid=1131618242334&aid=lvim9hFEbx8" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">Issue 19</a>
